...
function changeScreen(){
    ...
    fullscreenState?ExitFullscreen():FullScreen();
}
...
document.addEventListener("fullscreenchange", function () {  
    ...
    fullscreenState = (document.fullscreen) ? true : false;  
}, false);  
  
document.addEventListener("mozfullscreenchange", function () {  
     
    fullscreenState = (document.mozFullScreen) ? true: false; 
}, false); 
 
document.addEventListener("webkitfullscreenchange", function () {  
      
    fullscreenState = (document.webkitIsFullScreen) ? true: false; 
}, false);  
